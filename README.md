...
1. Go to the [releases page of this Github repository](https://github.com/mattermost/mattermost-plugin-profanity-filter) and download the latest release for your Mattermost server.
